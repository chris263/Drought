...
Reading and simulating data. 2 Locations, 14 varieties, 3 rep, 2 treatments, 3 times (days).
...
## Modeling with 4 different interactions
...
dfinal <- df %>% separate(x, c("treatments","varieties"), sep = ":")
...
trt_Drought <- c(rep("Drought",12))
trt_Wattered <- c(rep("Wattered",12))
